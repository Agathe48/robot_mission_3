...
model_params = {
    "nb_green_agents": mesa.visualization.Slider("Initial number of green agents", 4, 1, 6, 1),
    "nb_yellow_agents": mesa.visualization.Slider("Initial number of yellow agents", 4, 1, 6, 1) ,
    "nb_red_agents": mesa.visualization.Slider("Initial number of red agents", 4, 1, 6, 1),
